...
export function ListIconGlyph(p: IconProps) {
  return (
    <Svg {...p}>
...
export function LanguagesIcon(p: IconProps) {
  return (
    <Svg {...p}>
      <path d="M4 5h9M7 3v2m0 0c0 4.5-3 8-5 9m3-4c1.5 1.8 3.4 3 5 3.5" />
      <path d="m14 21 5-11 5 11M15.5 17h7" />
    </Svg>
  );
}
...
export function UsersIcon(p: IconProps) {
  return (
    <Svg {...p}>
      ...
      <path d="M16.5 4.5a3.5 3.5 0 0 1 0 7M21.5 20a6 6 0 0 0-4.7-6" />
    </Svg>
  );
}
